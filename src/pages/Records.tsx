                  ...
                  >
                    ...
                    <div className="absolute top-2 right-2 flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs text-gray-600">기록</span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        ...
                        className="flex-1 py-1.5 px-3 bg-[#FF6B6B] text-white rounded-md hover:bg-[#FF5252] transition-colors text-xs font-medium"
                      >
                        삭제하기
                      </button>
                    </div>
