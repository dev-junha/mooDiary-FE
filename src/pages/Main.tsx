          ...
          <section className="pb-16 mt-12">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-10 sm:gap-16">
              {[
                ...
                { src: "/movie.png", alt: "영화 아이콘", label: "영화", to: "/movies" },
                { src: "/music.png", alt: "헤드폰 아이콘", label: "음악", to: "/music" },
                { src: "/book.png", alt: "책 아이콘", label: "시", to: "/poem" },
                { src: "/phrase.png", alt: "명언", label: "명언", to: "/phrase" },
              ].map((item, i) => (
